...
Requires: httpd, mod_wsgi, mod_ssl, python, python-django-bootstrap3, django-countries >= 5.0, python-django-rest-framework, python-django >= 1.8, pyOpenSSL >= 0.14, python-ldap, python-pyasn1 >= 0.1.7 , python-pyasn1-modules >= 0.1.7, python-six, python-cryptography >= 2.0.2, django-formtools >= 1.0, python-django-tagging >= 0.3.6
