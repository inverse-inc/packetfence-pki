...
urlpatterns = patterns('',
    ...
    url(r'/cert/rest/get/(?P<pk>(.*))/$',     views.cert_detail.as_view()),
    url(r'/cert/rest/revoke/(?P<pk>(.*))/$',  views.cert_revoke.as_view()),
    ...
    url(r'/certrevoked/$',                    login_required(views.list_certrevoked.as_view(),login_url='/logon/'), name='certrevoked_list'),
