...
class CA(models.Model):
    ...
    issuerKeyHashmd5 = models.TextField(db_index=True, blank=1,null=1,max_length=33,editable=False)
    issuerKeyHashsha1 = models.TextField(db_index=True, blank=1,null=1,max_length=41,editable=False)
    issuerKeyHashsha256 = models.TextField(db_index=True, blank=1,null=1,max_length=65,editable=False)
    issuerKeyHashsha512 = models.TextField(db_index=True, blank=1,null=1,max_length=129,editable=False)
    def sign(self):
        k = crypto.PKey()
