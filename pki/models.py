...
class CA(models.Model):
    ...
    issuerKeyHashmd5 = models.CharField(db_index=True, blank=1,null=1,max_length=33,editable=False)
    issuerKeyHashsha1 = models.CharField(db_index=True, blank=1,null=1,max_length=41,editable=False)
    issuerKeyHashsha256 = models.CharField(db_index=True, blank=1,null=1,max_length=65,editable=False)
    issuerKeyHashsha512 = models.CharField(db_index=True, blank=1,null=1,max_length=129,editable=False)
    def sign(self):
        k = crypto.PKey()
...
class Cert(models.Model):
    ...
    userIssuerHashmd5 = models.CharField(db_index=True, blank=1,null=1,max_length=33,editable=False)
    userIssuerHashsha1 = models.CharField(db_index=True, blank=1,null=1,max_length=41,editable=False)
    userIssuerHashsha256 = models.CharField(db_index=True, blank=1,null=1,max_length=65,editable=False)
    userIssuerHashsha512 = models.CharField(db_index=True, blank=1,null=1,max_length=129,editable=False)
